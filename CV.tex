...
\section*{\Large{Noções + Interesses} \small{\textbf{(WIP)}}}
...
\item \textbf{LINGUAGENS DE PROGRAMAÇÃO:} (LISP), $\bigoplus$Clojure, $\bigoplus$Clojurescript, C/C++, Go, Python, Java, Javascript.
